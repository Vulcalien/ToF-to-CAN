 ...
 *
 ...
 THIS LIB HAS BEEN MODIFIED BY CORRADO SANTORO IN ORDER TO BE INCLUDED
 IN THE TREE OF UNICT-TEAM-EUROBOT SOFTWARE
...
*/
class Adafruit_SSD1306 : public Adafruit_GFX,I2C_Dev {
public:
  // NEW CONSTRUCTORS -- recommended for new projects
  Adafruit_SSD1306(uint8_t w, uint8_t h, FAR struct i2c_master_s *i2c_device);
